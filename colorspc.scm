...
;;; Converting spectra
(define cie:x-bar #(0.0014 0.0022 0.0042 0.0076 0.0143 0.0232 0.0435 0.0776
...
(define cie:y-bar #( 0.0000 0.0001 0.0001 0.0002 0.0004 0.0006 0.0012 0.0022
...
(define cie:z-bar #(0.0065 0.0105 0.0201 0.0362 0.0679 0.1102 0.2074 0.3713
